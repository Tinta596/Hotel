...
export default {
  ...
  methods: {
    ...
    async calcularPrecio() {
      console.log('Ejecutando calcularPrecio()');
      console.log('Habitación seleccionada:', this.habitacionSeleccionada);
      console.log('Tipo de habitación ID:', this.habitacionSeleccionada?.tipo_id);
      console.log('Fechas:', this.fechaCheckin, this.fechaCheckout);
